...
import type { Finding, MethodologyData, Explanation } from "../../../shared/types";
...
export interface ExplanationPanelProps {
  ...
  /** Override border color for the header (e.g. dark theme panels) */
  borderColor?: string;
  /** Override button background (e.g. dark theme panels) */
  buttonBg?: string;
  /** Override default overview title */
  overviewTitle?: string;
  /** Override fallback overview text */
  overviewFallbackText?: string;
}

export default function ExplanationPanel({
  activeData, isOverview, findingIndex, total, onNavigate,
  overallCertainty, findingsCount, overviewData,
  borderColor, buttonBg, overviewTitle, overviewFallbackText,
  ...
  return (
    ...
    >
      <div style={{ padding: "16px 20px 12px", borderBottom: `1px solid ${bColor}`, flexShrink: 0 }}>
        <div
          style={{
            fontSize: 10,
            fontWeight: 700,
      ...
      <div style={{ flex: 1, overflow: "auto", padding: "16px 20px" }}>
        <h3 style={{ fontSize: 15, fontWeight: 700, color: COLORS.text, margin: "0 0 10px", lineHeight: 1.3 }}>
          {isOverview
            ? (overviewData?.explanation?.title || overviewTitle || "Report Methodology")
