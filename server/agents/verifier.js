...
Each finding in the output MUST have this structure:
{
  ...
  "explanation": {
    ...
    "supportingEvidence": [
      { "source": "Source Name", "quote": "Substantial quote with full context — 2-4 sentences providing the data point and its surrounding context", "url": "https://example.com/full/path/to/article" }
    ],
    "contraryEvidence": [
      { "source": "Source Name", "quote": "Substantial contradicting data point, caveat, or alternative interpretation — 2-4 sentences with full context", "url": "https://example.com/full/path/to/article" }
    ]
  }
}
...
- Preserve the full URLs from the existing evidence. When adding new contraryEvidence, use full, realistic URLs (e.g., "https://www.reuters.com/technology/nvidia-faces-export-restrictions-2025"). For non-specific sources, use url: "general" (common knowledge), "various" (multiple sources), or "derived" (calculations)
- Quotes should be SUBSTANTIAL — 2-4 sentences (40-100 words) providing full context, not just a short fragment. When preserving existing quotes, keep their full length. When adding new contraryEvidence, write detailed quotes
...
METHODOLOGY OVERVIEW — Add a "methodology" object to meta with this structure:
{
  "methodology": {
    "explanation": {
      ...
      "supportingEvidence": [
        { "source": "Primary Source Category", "quote": "What this source contributed to the report — provide detailed context about the types of data and how many data points were drawn from this source category", "url": "https://example.com/full/path/to/source" }
      ],
      "contraryEvidence": [
